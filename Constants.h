...
namespace Constants {
	...
	static std::map<TString,std::pair<double,double> > XSecRange =
	{
		...
		{ "DeltaAlphaT_ProtonCosTheta_Minus1_00To0_00Plot",  std::make_pair(0, 0.02) },
		{ "DeltaAlphaT_ProtonCosTheta_0_00To0_50Plot",  std::make_pair(0, 0.03) },
		{ "DeltaAlphaT_ProtonCosTheta_0_50To0_75Plot",  std::make_pair(0, 0.04) },
		{ "DeltaAlphaT_ProtonCosTheta_0_75To1_00Plot",  std::make_pair(0, 0.06) },		
		...
		{ "ProtonCosTheta_MuonCosTheta_Minus1_00To0_00Plot",  std::make_pair(0, 24.) },
		{ "ProtonCosTheta_MuonCosTheta_0_00To0_50Plot",  std::make_pair(0, 24.) },
		{ "ProtonCosTheta_MuonCosTheta_0_50To0_75Plot",  std::make_pair(0, 24.) },
		{ "ProtonCosTheta_MuonCosTheta_0_75To1_00Plot",  std::make_pair(0, 24.) },		
		...
		{ "DeltaPtx_DeltaPty_Minus0_75ToMinus0_15Plot",  std::make_pair(0, 11.) },
		{ "DeltaPtx_DeltaPty_Minus0_15To0_15Plot",  std::make_pair(0, 44.) },
		{ "DeltaPtx_DeltaPty_0_15To0_45Plot",  std::make_pair(0, 3.9) },
		...
		{ "SerialDeltaPT_MuonCosThetaPlot",  std::make_pair(0, 14.) },
		{ "SerialDeltaPT_ProtonCosThetaPlot",  std::make_pair(0, 14.) },
		{ "SerialMuonMomentum_MuonCosThetaPlot",  std::make_pair(0, 14.) },
		{ "SerialProtonMomentum_ProtonCosThetaPlot",  std::make_pair(0, 14.) },
		{ "SerialDeltaAlphaT_MuonCosThetaPlot",  std::make_pair(0, 14.) },								
		{ "SerialDeltaAlphaT_ProtonCosThetaPlot",  std::make_pair(0, 14.) },
		{ "SerialDeltaAlphaT_DeltaPTPlot",  std::make_pair(0, 14.) },
		{ "SerialDeltaPhiT_DeltaPTPlot",  std::make_pair(0, 14.) },
		{ "SerialDeltaPn_DeltaPTPlot",  std::make_pair(0, 14.) },
		{ "SerialECal_DeltaPTPlot",  std::make_pair(0, 14.) },
		{ "SerialProtonCosTheta_MuonCosThetaPlot",  std::make_pair(0, 14.) },
		{ "SerialDeltaPty_DeltaPtxPlot",  std::make_pair(0, 14.) },
		{ "SerialDeltaPtx_DeltaPtyPlot",  std::make_pair(0, 14.) },
	...
	static std::map<TString,TString> VarLabel =
	{
		...
		{ "DeltaAlphaT_ProtonCosTheta_Minus1_00To0_00Plot",  "#frac{d#sigma}{d#delta#alpha_{T}} #left[10^{-38} #frac{cm^{2}}{deg Ar}#right]" },
		{ "DeltaAlphaT_ProtonCosTheta_0_00To0_50Plot", "#frac{d#sigma}{d#delta#alpha_{T}} #left[10^{-38} #frac{cm^{2}}{deg Ar}#right]" },
		{ "DeltaAlphaT_ProtonCosTheta_0_50To0_75Plot", "#frac{d#sigma}{d#delta#alpha_{T}} #left[10^{-38} #frac{cm^{2}}{deg Ar}#right]" },
		{ "DeltaAlphaT_ProtonCosTheta_0_75To1_00Plot", "#frac{d#sigma}{d#delta#alpha_{T}} #left[10^{-38} #frac{cm^{2}}{deg Ar}#right]" },		
		...
		{ "ProtonCosTheta_MuonCosTheta_Minus1_00To0_00Plot",  "#frac{d#sigma}{dcos#theta_{p}} #left[10^{-38} #frac{cm^{2}}{Ar}#right]" },
		{ "ProtonCosTheta_MuonCosTheta_0_00To0_50Plot", "#frac{d#sigma}{dcos#theta_{p}} #left[10^{-38} #frac{cm^{2}}{Ar}#right]" },
		{ "ProtonCosTheta_MuonCosTheta_0_50To0_75Plot", "#frac{d#sigma}{dcos#theta_{p}} #left[10^{-38} #frac{cm^{2}}{Ar}#right]" },
		{ "ProtonCosTheta_MuonCosTheta_0_75To1_00Plot", "#frac{d#sigma}{dcos#theta_{p}} #left[10^{-38} #frac{cm^{2}}{Ar}#right]" },
		...
		{ "SerialMuonMomentum_MuonCosThetaPlot", "#frac{d^{2}#sigma}{dp_{#mu} dcos#theta_{#mu}} #left[10^{-38} #frac{cm^{2}}{GeV^{2}/c Ar}#right]" },
		{ "SerialProtonMomentum_ProtonCosThetaPlot", "#frac{d^{2}#sigma}{dp_{p} dcos#theta_{p}} #left[10^{-38} #frac{cm^{2}}{GeV^{2}/c Ar}#right]" },
		...
		{ "SerialDeltaAlphaT_DeltaPTPlot", "#frac{d^{2}#sigma}{d#delta#alpha_{T} d#delta p_{T}} #left[10^{-38} #frac{cm^{2}}{GeV/c deg Ar}#right]" },
		{ "SerialDeltaPhiT_DeltaPTPlot", "#frac{d^{2}#sigma}{d#delta#phi_{T} d#delta p_{T}} #left[10^{-38} #frac{cm^{2}}{GeV/c deg Ar}#right]" },
...
/*	const TString MinHitsP = " ( (CandidateP_Plane0_LastEDep > " + PMinSumHits + " && CandidateP_Plane1_LastEDep > " + PMinSumHits + " && CandidateP_Plane2_LastEDep > " + PMinSumHits +" ) || (CandidateP_Plane0_LastEDep < " + PMinSumHits + " && CandidateP_Plane1_LastEDep > " + PMinSumHits + " && CandidateP_Plane2_LastEDep > " + PMinSumHits +" ) || (CandidateP_Plane0_LastEDep > " + PMinSumHits + " && CandidateP_Plane1_LastEDep < " + PMinSumHits + " && CandidateP_Plane2_LastEDep > " + PMinSumHits +" ) || (CandidateP_Plane0_LastEDep > " + PMinSumHits + " && CandidateP_Plane1_LastEDep > " + PMinSumHits + " && CandidateP_Plane2_LastEDep < " + PMinSumHits +" ) )";*/
	...
	std::vector< std::vector<double> > TwoDArrayNBinsProtonCosThetaInMuonCosThetaSlices{ 
												{ -1.,-0.73,-0.43,-0.18,0.05,0.2,0.37,0.54,0.7,0.8,0.9,1.}, // -1    < cosθμ < 0
